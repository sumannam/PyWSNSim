...
FIELD_SIZE = 3000         # 필드 크기 (m)
NUM_NODES = 2000          # 센서 노드 수
BS_POSITION = (1500, 1500)  # 베이스 스테이션 위치 (x, y)

# Routing Parameters
ROUTING_PROTOCOL = "AODV"  # 라우팅 프로토콜 타입 ("dijkstra", "LEACH")
